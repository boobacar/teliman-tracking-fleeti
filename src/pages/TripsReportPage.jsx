...
function segmentStart(segment) {
  return segment?.from ?? segment?.start_time ?? segment?.begin ?? segment?.start ?? segment?.date_from ?? null
}

function segmentEnd(segment) {
  return segment?.to ?? segment?.end_time ?? segment?.finish ?? segment?.end ?? segment?.date_to ?? null
}
