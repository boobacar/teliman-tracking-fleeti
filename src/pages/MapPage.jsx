...
export function MapPage({ filteredTrackers, setSelectedTrackerId, deliveryOrders = [] }) {
  ...
  const [trackData, setTrackData] = useState({ points: [], segments: [] })
