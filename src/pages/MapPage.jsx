...
function createTrackerIcon(tracker, hasMission = false) {
  ...
  return L.divIcon({
    ...
    html: `<div class="custom-tracker-pin" style="background:${state.color}">${state.label}</div>${hasMission ? '<span class="mission-dot"></span>' : ''}`,
    iconSize: [32, 32],
    iconAnchor: [16, 16],
    popupAnchor: [0, -12],
  })
